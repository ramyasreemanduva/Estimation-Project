...
dt = 0.01 
# Capture all three outputs from the simulator
true_states, inner_bound, outer_bound = get_track_geometry(dt)
...
# FIX: Pass the inner and outer boundaries to the function
